...
static void help(int exit_code = 1)
{
  ...
  fprintf(stderr, "  -c            Generate a log of CSR transition info\n");
...
int main(int argc, char** argv)
{
  ...
  // Add option for output csr transition --coverage
  parser.option('c', 0, 0, [&](const char UNUSED *s){coverage = true;});
